...
export default function App() {
  ...
  const defaultStoreProducts = [
    { id: 'ebook-confidence', title: 'Confidence for Teens', description: 'A step-by-step digital guide to help young people build confidence, healthy habits, and emotional resilience.', price: 5500, category: 'Ebook', cover: '/logo/logomain.png', fileUrl: 'https://example.com/files/confidence-for-teens.pdf', inStock: true, stockCount: 245 },
    { id: 'ebook-parent-guide', title: 'Thriving Parent Guide', description: 'Practical strategies for communication, boundaries, and positive family routines with everyday life examples.', price: 7000, category: 'Guide', cover: '/logo/logo2.jpeg', fileUrl: 'https://example.com/files/thriving-parent-guide.pdf', inStock: true, stockCount: 156 },
    { id: 'digital-workbook', title: 'Purpose Planner Workbook', description: 'A printable workbook for self-discovery, goal setting, and building a more intentional life.', price: 4500, category: 'Workbook', cover: '/logo/logo2.jpeg', fileUrl: 'https://example.com/files/purpose-planner-workbook.pdf', inStock: true, stockCount: 312 },
    { id: 'family-routine-kit', title: 'Family Routine Kit', description: 'A practical planner for mornings, chores, family rhythms, and calmer home routines.', price: 6200, category: 'Planner', cover: '/logo/logomain.png', fileUrl: 'https://example.com/files/family-routine-kit.pdf', inStock: true, stockCount: 120 },
    { id: 'mindful-moments', title: 'Mindful Moments Journal', description: 'A guided reflection journal for emotional regulation, gratitude, and self-awareness.', price: 4800, category: 'Journal', cover: '/logo/logo2.jpeg', fileUrl: 'https://example.com/files/mindful-moments-journal.pdf', inStock: true, stockCount: 84 },
    { id: 'teen-vision-board', title: 'Teen Vision Board Pack', description: 'Design and goal-setting activities that help young people dream bigger and act with intention.', price: 5300, category: 'Workbook', cover: '/logo/logomain.png', fileUrl: 'https://example.com/files/teen-vision-board-pack.pdf', inStock: true, stockCount: 142 },
    { id: 'boundaries-bundle', title: 'Boundaries Bundle', description: 'A supportive toolkit for healthy conversations, personal limits, and respectful relationships.', price: 6700, category: 'Guide', cover: '/logo/logo2.jpeg', fileUrl: 'https://example.com/files/boundaries-bundle.pdf', inStock: true, stockCount: 77 },
    { id: 'purpose-pathway', title: 'Purpose Pathway Mini Course', description: 'A short digital course that helps users discover their values, strengths, and next steps.', price: 8200, category: 'Course', cover: '/logo/logomain.png', fileUrl: 'https://example.com/files/purpose-pathway.pdf', inStock: true, stockCount: 93 },
    { id: 'calm-parenting', title: 'Calm Parenting Playbook', description: 'Simple routines and scripts for more patience, connection, and calm in everyday parenting.', price: 7100, category: 'Guide', cover: '/logo/logo2.jpeg', fileUrl: 'https://example.com/files/calm-parenting-playbook.pdf', inStock: true, stockCount: 131 },
    { id: 'summer-growth-plan', title: 'Summer Growth Plan', description: 'A seasonal planner that helps families set meaningful goals, habits, and joyful wins.', price: 5900, category: 'Planner', cover: '/logo/logomain.png', fileUrl: 'https://example.com/files/summer-growth-plan.pdf', inStock: true, stockCount: 108 },
    { id: 'decision-making-guide', title: 'Smart Decision Making Guide', description: 'Learn frameworks and strategies for making sound decisions that align with your values and goals.', price: 6300, category: 'Guide', cover: '/logo/logo2.jpeg', fileUrl: 'https://example.com/files/decision-making.pdf', inStock: true, stockCount: 98 },
    { id: 'passion-discovery', title: 'Passion & Purpose Discovery Workbook', description: 'Explore your interests and talents to discover your true passion and life purpose.', price: 5100, category: 'Workbook', cover: '/logo/logomain.png', fileUrl: 'https://example.com/files/passion-discovery.pdf', inStock: true, stockCount: 142 },
    { id: 'habit-builder-kit', title: 'Habit Builder Starter Kit', description: 'Create sustainable routines with mini plans, reflection prompts, and motivation trackers.', price: 5400, category: 'Planner', cover: '/logo/logo2.jpeg', fileUrl: 'https://example.com/files/habit-builder-kit.pdf', inStock: true, stockCount: 116 },
    { id: 'parent-reset', title: 'Parent Reset Journal', description: 'A simple reflection tool to help parents reset and reconnect with calmer routines.', price: 4900, category: 'Journal', cover: '/logo/logomain.png', fileUrl: 'https://example.com/files/parent-reset-journal.pdf', inStock: true, stockCount: 103 },
    { id: 'rooting-identity', title: 'Rooting in Identity', description: 'A guided resource to help teens understand identity, values, and belonging in everyday life.', price: 6800, category: 'Ebook', cover: '/logo/logo2.jpeg', fileUrl: 'https://example.com/files/rooting-in-identity.pdf', inStock: true, stockCount: 89 },
    { id: 'family-rituals', title: 'Family Rituals Planner', description: 'Design meaningful rituals that build connection and belonging across family life.', price: 6100, category: 'Planner', cover: '/logo/logomain.png', fileUrl: 'https://example.com/files/family-rituals-planner.pdf', inStock: true, stockCount: 92 },
    { id: 'teen-balance', title: 'Teen Balance Blueprint', description: 'A focused digital toolkit for balancing school, rest, boundaries, and personal growth.', price: 7200, category: 'Guide', cover: '/logo/logo2.jpeg', fileUrl: 'https://example.com/files/teen-balance-blueprint.pdf', inStock: true, stockCount: 72 },
    { id: 'resilience-workbook', title: 'Resilience Reset Workbook', description: 'Build emotional resilience with small actions, practical check-ins, and gentle reflection.', price: 5600, category: 'Workbook', cover: '/logo/logomain.png', fileUrl: 'https://example.com/files/resilience-reset-workbook.pdf', inStock: true, stockCount: 127 },
    { id: 'focus-fuel', title: 'Focus Fuel Mini Guide', description: 'A short guide for creating systems that help individuals stay grounded, focused, and intentional.', price: 4700, category: 'Guide', cover: '/logo/logo2.jpeg', fileUrl: 'https://example.com/files/focus-fuel-mini-guide.pdf', inStock: true, stockCount: 164 },
    { id: 'thriving-teen-kit', title: 'Thriving Teen Starter Kit', description: 'A combination of checklists, prompts, and routines to support growth and confidence in everyday life.', price: 7600, category: 'Course', cover: '/logo/logomain.png', fileUrl: 'https://example.com/files/thriving-teen-starter-kit.pdf', inStock: true, stockCount: 58 }
  ];
    ...
    <>
      <style>{`
        ...
        .nav-cta-btn {
          ...
          gap: 0.45rem; white-space: nowrap;
          min-width: 2.6rem;
          overflow: hidden;
          transition: min-width 0.18s ease, padding 0.18s ease;
        }
        .nav-cta-btn span { display: inline-block; max-width: 0; opacity: 0; overflow: hidden; transition: max-width 0.18s ease, opacity 0.18s ease; }
        .nav-cta-btn:hover,
              ...
              <div className="public-website-container">
                ...
                {heroPopupMode && (
                  <ThriverRegistrationModal
                    ...
                    handleHeroBookingSubmit={handleHeroBookingSubmit}
                  />
                )}
